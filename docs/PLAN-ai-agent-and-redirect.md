...
**領域清單（新聞分類式，內建預設）**：
時事/新聞、八卦、明星/娛樂、影劇、音樂、科技、AI、財經/理財、股市、運動、
美食、旅遊、遊戲、動漫ACG、時尚/美妝、生活、健康、國際、社會、汽車3C、
親子、寵物、房產、星座命理。

> 敏感領域（政治、社會案件、八卦/明星）標記 `sensitive=true`：產文 prompt 加保守規則
> （避免誹謗、未證實指控、個資、煽動），降低帳號與法律風險；發文仍一律待人工核准。
